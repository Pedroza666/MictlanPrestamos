...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div id="mensaje" class="alert alert-info">
            PUEDES BUSCAR AL CLIENTE POR N° TELEFONICO, NOMBRE , CORREO O N° DE IDENTIFICACION
        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-lg-6 form-group">
                            <label>Importe</label>
                            <input type="number" id="importe_credito" name="importe_credito" class="form-control" value="<?php echo set_value('importe_credito'); ?>" placeholder="Importe">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <select class="form-select" name="modalidad">
                                ...
                                <option value="QUINCENAL" <?= set_select('modalidad', 'QUINCENAL', (!empty($modalidad) && $modalidad == 'QUINCENAL' ? true : false)) ?>>QUINCENAL</option>
